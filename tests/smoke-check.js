...
assert(/↻ Latest/.test(appSource), "Header latest-version button missing");
...
assert(/TimelineVisual/.test(appSource), "Timeline visual helper missing");
assert(/LandmarkVisual/.test(appSource), "Landmark visual helper missing");
assert(/OrgVisual/.test(appSource), "World organisations visual helper missing");
assert(/SymbolVisual/.test(appSource), "Symbols visual helper missing");
